export const SKILLS_ICONS: Record<string, { iconName: string }> = {
	...
	Spring: {iconName: "skill-icons:spring"},
	Java: {iconName: "skill-icons:java-dark"},
	Angular: { iconName: "skill-icons:angular-dark" },
	Ansible: { iconName: "skill-icons:ansible" },
	Jenkins: { iconName: "skill-icons:jenkins-dark" },
	Azure: { iconName: "skill-icons:azure-dark" },
	Tellaform: { iconName: "skill-icons:tellafarm-dark" },
